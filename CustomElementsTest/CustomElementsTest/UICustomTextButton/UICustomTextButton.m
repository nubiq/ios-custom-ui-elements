...
@implementation UICustomTextButton
...
- (id)initWithText:(NSString *)text target:(id)target selector:(SEL)selector {
	...
	return [self initWithTextAndHSB:text target:target selector:selector hue:0.0f
                         saturation:0.0f brightness:0.0f];
}
